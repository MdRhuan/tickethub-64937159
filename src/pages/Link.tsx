      ...
      <div className="lk-root">
        <div className="lk-wrap">
          ...
          <div style={{ display: 'flex', gap: 10, marginBottom: 24 }}>
            <SocialBtn href="https://www.tickethubh.com.br/" label="Site oficial"><SiteIcon /></SocialBtn>
          ...
          <nav aria-label="Links principais" style={{ display: 'flex', flexDirection: 'column', gap: 10, width: '100%' }}>
            <LinkCard href="https://www.tickethubh.com.br/" icon={<SiteIcon />} label="Site Oficial" />
