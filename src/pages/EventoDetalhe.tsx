  ...
  return (
    <>
      ...
      <section className="relative min-h-[440px] max-md:min-h-[360px] flex items-end page-px pb-20 max-md:pb-24 pt-8 overflow-hidden">
        <div
          className="absolute inset-0 bg-[#2a2a3e]"
          style={
            heroBg
      ...
      <div className="grid gap-[52px] page-px py-[44px] pb-20 items-start max-md:gap-8 grid-cols-1 md:grid-cols-[minmax(0,1fr)_380px]">
        ...
        <div className="flex flex-col gap-9">
          {/* Sobre */}
          <div>
            <h2 className="text-[20px] font-black text-[#111] mb-[14px] pb-[10px] border-b-2 border-[#f0f0f0]">
              Sobre o Evento
            </h2>
            <div className="evento-descricao text-[15px] text-[#555]">
            ...
            <div>
              ...
              <div className="flex flex-row gap-3 flex-wrap">
                {ev.atracoes.map((at, i) => (
                  <div
                    key={i}
                    className="flex flex-col items-center gap-3 p-5 px-4 bg-white rounded-xl border border-[#eee] flex-1 min-w-[120px] text-center shadow-[0_2px_10px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_24px_rgba(0,0,0,0.10)] hover:-translate-y-1 transition-all duration-300 max-md:min-w-[100px] max-md:p-[14px]"
                  >
                    <div
        ...
        <div className="flex flex-col gap-4 sticky top-20 max-md:static">
            ...
            {[
              {
                ...
                label: allDates.length > 1 ? "Datas" : "Data",
                value: datasLabel || null,
              },
              {
                icon: (
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4a90e2" strokeWidth="2">
          ...
          {allDates.length > 0 && (
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 px-5 py-[14px] rounded-2xl border border-[#eee] bg-white text-[#1a3a6b] text-[15px] font-bold cursor-pointer hover:border-[#4a90e2] hover:shadow-[0_8px_24px_rgba(74,144,226,0.15)] transition-all"
            >
          ...
          <div className="mt-1">
            <a
              href="https://chat.whatsapp.com/EGrwvkC1N8WJyfp9Rsb8LM"
              target="_blank"
              rel="noopener noreferrer"
              className="w-full inline-flex items-center justify-center gap-2 bg-[#25D366] text-white no-underline font-bold text-[15px] px-5 py-[14px] rounded-full"
            >
            ...
            <p className="text-center text-[12px] text-[#888] mt-2">Participe e receba ofertas exclusivas</p>
          </div>
        ...
        >
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              <a
                href={`https://wa.me/?text=${encodeURIComponent(ev.titulo + " — " + shareUrl)}`}
                target="_blank"
                rel="noopener"
                className="flex items-center gap-[10px] px-4 py-3 rounded-[10px] bg-[#e8f8ef] text-[#25d366] text-sm font-semibold no-underline hover:opacity-85 transition-opacity"
              >
              ...
              <a
                href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(ev.titulo)}&url=${encodeURIComponent(shareUrl)}`}
                target="_blank"
                rel="noopener"
                className="flex items-center gap-[10px] px-4 py-3 rounded-[10px] bg-[#e8f0fb] text-[#000] text-sm font-semibold no-underline hover:opacity-85 transition-opacity"
              >
            ...
            <div className="flex gap-[10px] border-t border-[#f0f0f0] pt-5">
              <input
                readOnly
                value={shareUrl}
                className="flex-1 px-[14px] py-[10px] border border-[#ddd] rounded-lg text-[13px] text-[#555] bg-[#fafafa] outline-none"
              />
              <button
                onClick={copyLink}
                className="px-5 py-[10px] bg-[#1a3a6b] text-white border-none rounded-lg text-[13px] font-bold cursor-pointer hover:bg-[#102a4e] transition-colors whitespace-nowrap btn-pulse"
              >
