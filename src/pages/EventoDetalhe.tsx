        ...
        <div className="flex flex-col gap-9">
          ...
          <div>
            ...
            {(ev.sobre || "Informações detalhadas sobre o evento em breve.")
              ...
              .filter(Boolean)
              .map((para, i) => (
                <p key={i} className="text-[15px] text-[#555] leading-[1.8] mb-4 last:mb-0">
                  {para}
                </p>
              ))}
          </div>
        ...
        <div className="flex flex-col gap-4 sticky top-20 max-md:static">
          ...
          <div className="mt-1">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full inline-flex items-center justify-center gap-2 bg-[#25D366] text-white no-underline font-bold text-[15px] px-5 py-[14px] rounded-full btn-pulse"
            >
